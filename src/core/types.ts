...
/** Closed doctrinal responses per JWG hypothesis family. */
export type PlutoSouthNodeResponse = "reliving" | "fruition" | "dual";
export type SkippedStepResponse = "activo" | "en_proceso" | "integrado";
export type NodalIntegrationResponse =
	| "polo_sur"
	| "en_transicion"
	| "polo_norte";

export type HypothesisResponseEnum =
	| PlutoSouthNodeResponse
	| SkippedStepResponse
	| NodalIntegrationResponse;

export interface Hypothesis {
	id: string;
	campo: string;
	pregunta: string;
	respuestasValidas: readonly HypothesisResponseEnum[];
